...
if (file_exists($CFG->dirroot . '/auth/saml2/.extlib/simplesamlphp/lib/SimpleSAML/Store.php')) {
    ...
    || file_exists($CFG->dirroot . '/auth/saml2/vendor/simplesamlphp/simplesamlphp/src/SimpleSAML/Store/StoreInterface.php')) {

    if (file_exists($CFG->dirroot . '/auth/saml2/vendor/simplesamlphp/simplesamlphp/src/SimpleSAML/Store/StoreInterface.php')) {
        // auth_saml2 version 2025040400 or newer
        require_once($CFG->dirroot . '/auth/saml2/vendor/simplesamlphp/simplesamlphp/src/SimpleSAML/Store/StoreInterface.php');
    } else {
